...
const CoinMiningItem = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/api/user/coin/mining/earning/view/${authUser.userName}/${id}`, {
            method: 'GET',
            headers: {
                'authorization':
            ...
            <div className='container mt-2 '>
                <div className="row row-cols-1 row-cols-md-2  row-cols-lg-4 g-4">
                    <div className="col">
                        <div className="card total shadow-lg usd-gen-mining-color1 p-1  bg-body rounded border-0">
                            <div className="card-body card-image">
                                <h3><i class="fa-solid fa-bitcoin-sign"></i> Total  Mining</h3>
                    ...
                    <div className="col">
                        <div className="card total shadow-lg usd-gen-mining-color1 p-1  bg-body rounded border-0">
                            <div className="card-body card-image">
                                <h3><i class="fa-solid fa-money-bill-transfer"></i> Pending Mining</h3>
                                <div className='price d-flex text-center'>
                                    <i class="fa-solid fa-comments-dollar"></i>
